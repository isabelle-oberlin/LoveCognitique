...
<html>
        <?php
            ...
            if (!isAdminConnected() && isUserConnected())
            {
                ...
                //Recherche les paramètres de confidentialite pour la modification du profil (que les sliders s'affichent bien)
                ...
                //Recherche les informations relatives a la ville de l'eleve
            ...
            <div class=" content">
                <div class="Jumbotron container">
                    ...
                    <div id="add" class="form-container collapse in">
                            <form class="form-horizontal" method ="POST" action ="traitementProfil.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="select mx-3">
                                            <select name="poste" required placeholder="Pays">
                    ...
                    <?php foreach($experiences as $experience){ ?>
                        ...
                        <!-- EDITION DE L'EXPERIENCE PREREMPLIE -->
