...
<body>
    ...
    <?php if(isAdminConnected()) {?>
      ...
      <h1 class="display-3"><a href = "inscription.php">Créer un compte élève</a></h1>
      <p class="lead">Créer un compte à un élève. Vous pourrez ensuite lui transmettre les informations de connexion.</p>
      <h1 class="display-3"><a href = "FIXME">Créer un compte à un groupes d'élèves à partir d'un fichier</a></h1>
