...
<body>
    ...
    <?php if(isAdminConnected()) {?>
      ...
      <h1 class="display-3"><a href = "inscriptiongroupe.php">Créer un compte à un groupes d'élèves à partir d'un fichier</a></h1>      <p class="lead"> Créer de façon automatisée les comptes d'un groupe d'élève à partir d'une liste.</p>
